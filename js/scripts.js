  ...
  switch (choice) {
    case 'public transit':
      ...
      case 'walking':
        return {
          color: '#94C2FF',
          description: 'Walking is the top choice',
        };
    ...
    case 'taxi':
      ...
      case 'FHV':
        return {
          color: '#FCCF76',
          description: 'FHV is the top choice',
        };

        case 'shared FHV':
          return {
            color: '#A3FFB6',
            description: 'Shared FH is the top choice',
          };
...
let mode = ['public transit', 'walking', 'taxi', 'FHV', 'shared FHV'];
    ...
    paint: {
      ...
      'fill-color' : {
        ...
        stops: [
          ...
          [
            'walking',
            TopTransportation('walking').color,
          ],
          [
            'taxi',
          ...
          [
            'FHV',
            TopTransportation('FHV').color,
          ],
          [
            'shared FHV',
            TopTransportation('shared FHV').color,
          ],
        ]
      }
    }
  ...
  map.on('mousemove', function(e) {
    ...
    if (taxi_zone) {
      ...
      var pieData = [
          ...
          {
            'label': 'walking',
            'value': taxi_zone.properties.Walking
          },
          {
            'label': 'taxi',
          ...
          {
            'label': 'FHV',
            'value': taxi_zone.properties.FHV
          },
          {
            'label': 'shared FHV',
            'value': taxi_zone.properties.shared_FHV
          },
        ];
